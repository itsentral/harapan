...
<style>
    #tblPenjualanHppDlv thead th {
        white-space: nowrap;
        font-size: 12px;
    }
    #tblPenjualanHppDlv tbody td {
        font-size: 12px;
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="tblPenjualanHppDlv" style="width:100%">
                <thead>
                    <tr>
                        <th class="text-center" style="width:35px">No</th>
                        <th class="text-center">NOMOR DELIVERY</th>
                ...
                <tfoot>
                    <tr class="footer-total">
                        ...
                        <td class="text-right" id="footHargaJual">0</td>
...
$(document).ready(function () {
    ...
    $('#btnFilter').on('click', function () {
        $('#tblPenjualanHppDlv').DataTable().ajax.reload();
    });
    ...
    $('#btnExportExcel').on('click', function () {
        ...
        var searchVal  = $('#tblPenjualanHppDlv_filter input').val();
    ...
    $('#tblPenjualanHppDlv').DataTable({
        ...
        ajax: {
            ...
            dataSrc: function (json) {
                var sumHargaJual = json.sumHargaJual || 0;
                var sumHPP       = json.sumHPP || 0;
                var sumLaba      = json.sumLaba || 0;
                var pLaba = sumHargaJual > 0 ? Math.round((sumLaba / sumHargaJual) * 100) : 0;

                $('#footHargaJual').html('<strong>' + formatNumber(sumHargaJual) + '</strong>');
            ...
            cache: false,
            error: function () {
                $("#tblPenjualanHppDlv tbody").html(
                    '<tr><th colspan="12" class="text-center">No data found in the server</th></tr>'
                );
            }
        }
    });
