...
class Warehouse_model extends BF_Model
{
    ...
    // ==========================================================
    // KARTU STOK - INCOMING ONLY
    // ==========================================================
    public function get_json_kartu_stok_incoming()
    {
        $requestData = $_REQUEST;

        $fetch = $this->get_query_json_kartu_stok_incoming(
            $requestData['search']['value'],
            $requestData['order'][0]['column'],
            $requestData['order'][0]['dir'],
            $requestData['start'],
    ...
    public function get_query_json_kartu_stok_incoming($like_value = null, $column_order = null, $column_dir = null, $limit_start = null, $limit_length = null, $start_date = null, $end_date = null)
    {
        $columns_order_by = [
            0 => 'ks.id',
            1 => 'ks.tgl_transaksi',
        ...
        // Filter khusus INCOMING: hanya transaksi barang masuk ke gudang.
        // Jenis transaksi incoming dari incoming_check & incoming module.
