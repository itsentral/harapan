...
class Surat_jalan_pabrik extends Admin_Controller
{
    ...
    public function save()
    {
        ...
        //
        // Sumber sengaja dibuat identik dengan get detail (COALESCE(w.harga_beli,0)) dan
        // subquery pada confirm_sj()/view_confirm() (MAX(harga_beli)), sehingga costbook beku
        // SAMA dengan dasar perhitungan jurnal saat Save maupun Confirm.
        $costbookMap = [];
