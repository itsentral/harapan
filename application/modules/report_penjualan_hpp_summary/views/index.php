...
<style>
    #tblPenjualanHppSum thead th {
        white-space: nowrap;
        font-size: 12px;
    }
    #tblPenjualanHppSum tbody td {
        font-size: 12px;
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="tblPenjualanHppSum" style="width:100%">
                <thead>
                    <tr>
...
$(document).ready(function () {
    ...
    $('#btnFilter').on('click', function () {
        $('#tblPenjualanHppSum').DataTable().ajax.reload();
    });
    ...
    $('#btnExportExcel').on('click', function () {
        ...
        var searchVal  = $('#tblPenjualanHppSum_filter input').val();
